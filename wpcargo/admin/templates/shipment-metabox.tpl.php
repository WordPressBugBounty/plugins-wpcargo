...
<div id="shipment-details">
	...
	<table class="wpcargo form-table">
		...
		<tr>
			...
			<td><input type="text" id="wpcargo_courier" name="wpcargo_courier" value="<?php echo esc_html( get_post_meta($post->ID, 'wpcargo_courier', true) ); ?>"size="25" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input type="text" id="prod" name="wpcargo_product" value="<?php echo esc_html( get_post_meta($post->ID, 'wpcargo_product', true) ); ?>" size="25" /></td>
		</tr>
		<tr>
			<th><label><?php esc_html_e('Quantity', 'wpcargo'); ?></label></th>
			<td><input type="text" id="wpcargo_qty" name="wpcargo_qty" value="<?php echo esc_html( get_post_meta($post->ID, 'wpcargo_qty', true) ); ?>" size="25" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input type="text" id="wpcargo_total_freight" name="wpcargo_total_freight" value="<?php echo esc_html( get_post_meta($post->ID, 'wpcargo_total_freight', true) ); ?>"size="25" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input type="text" id="wpcargo_carrier_ref_number" name="wpcargo_carrier_ref_number" value="<?php echo esc_html( get_post_meta($post->ID, 'wpcargo_carrier_ref_number', true) ); ?>" size="25" /></td>
		</tr>
		<tr>
			<th><label><?php esc_html_e('Departure Time','wpcargo' ); ?></label></th>
			<td>
				<label for="UpdateDate"></label>
				<input type='text' class="wpcargo-timepicker" id='datetimepicker5' name="wpcargo_departure_time_picker" autocomplete="off" value="<?php echo esc_html( get_post_meta($post->ID, 'wpcargo_departure_time_picker', true) ); ?>"/>
			</td>
		</tr>
		<tr>
