...
<div id="print-shipper-info" class="wpcargo-row print-section">
	<div class="one-half first">
		<p id="print-shipper-header" class="header-title"><strong><?php echo esc_html(apply_filters('result_shipper_address', __('Shipper Address', 'wpcargo'))); ?></strong></p>
	...
	<div class="one-half">
		<p id="print-receiver-header" class="header-title"><strong><?php echo esc_html(apply_filters('result_receiver_address', __('Receiver Address', 'wpcargo'))); ?></strong></p>
