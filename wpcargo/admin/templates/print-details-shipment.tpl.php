...
<div id="print-shipment-info" class="wpcargo-row print-section">
	...
	<div class="one-third first">
		...
		<p class="wpcargo-label-info"><?php echo esc_html($shipment_destination); ?></p>
	</div>
	<div class="one-third">
	...
	<div class="one-third">
		...
		<p class="wpcargo-label-info"><?php echo esc_html($shipment_departure_time); ?></p>
	</div>
	<div class="one-third first">
	...
	<div class="one-third">
		...
		<p class="wpcargo-label-info"><?php echo esc_html($shipment_pickup_time); ?></p>
	</div>
	<div class="one-third">
