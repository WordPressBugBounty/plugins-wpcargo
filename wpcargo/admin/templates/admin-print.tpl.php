...
<style>
	...
	#package-table th { background: #333; color: white; font-weight: bold; }
	#package-table td, #package-table th, #admin-print-invoice td, #admin-print-invoice th { padding: 6px; text-align: <?php echo esc_html($rtl); ?>; }
	...
	@media only screen and (max-width: 760px), (min-device-width: 768px) and (max-device-width: 1024px){
		...
		<?php foreach ( wpcargo_package_fields() as $key => $value): ?>
			...
			#package-table td:nth-of-type(<?php echo esc_html($s_cnt); ?>):before { content: '<?php echo esc_html($value['label']); ?>'; }
