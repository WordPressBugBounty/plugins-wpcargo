...
<div class="wpcargo-track wpcargo">
	<form method="post" name="wpcargo-track-form" action="<?php echo esc_html( $get_action ); ?>">
		...
		<table id="wpcargo-track-table" class="track_form_table">
			...
			<?php echo wp_kses(apply_filters('wpcargo_example_text', ' <tr class="track_form_tr"><td class="track_form_td" colspan="2"><h4>'.__('Ex: 12345, 23456, 34567', 'wpcargo').'</h4></td></tr>'), 'post'); ?>
		</table>
	</form>
</div>